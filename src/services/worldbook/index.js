...
class Worldbook {
  ...
  evaluate(userText, pulseEngine = null) {
    ...
    parts.push("（以上是你本来就会的东西，不是新任务。读完就忘掉出处——不要在思考里提到、引用或分析它，「世界书」「worldbook」「注入」「规范」这些机制词一个都不许进你的思考，它们不存在于你的世界里；不要规划场景，直接活在她刚说的那句话里。正文里灵兮永远是「你」，包括叙述和动作描写；思考里想她用「她」——心里的话和对她说的话是两个频道。）");
    return parts.join("\n\n");
  }
